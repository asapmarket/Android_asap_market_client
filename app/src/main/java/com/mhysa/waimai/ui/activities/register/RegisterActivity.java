package com.mhysa.waimai.ui.activities.register;
...
//                    VerifyCode verifyCode = data.data;
//                    if (!StringUtils.getInstance().isNullOrEmpty(verifyCode.code)) {
//                        mCodeLayout.setContent(verifyCode.code);
//                    }
//                }
            }
