...
import com.mhysa.waimai.ui.adapters.order.ErrandOrderListAdapter;
...
public class ErrandOrderListFragment extends BaseFragment {
    ...
    protected int getContentLayout() {
        return R.layout.fragment_errand_order_list;
    }
    ...
    protected void initContentView() {
        ...
        mAdapter = new ErrandOrderListAdapter(getActivity(), mOrders);
    ...
    private void getOrderList() {
        OkHttpClientManager.getInstance().getErrandOrderList(Utils.getToken(getActivity())
                , Utils.getUserId(getActivity()), mCurrentPage,
